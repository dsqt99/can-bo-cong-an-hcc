...
import { User, Send, Volume2, VolumeX, Loader2, ShieldCheck, MessageCircle } from 'lucide-react';
...
export const MessageList: React.FC<MessageListProps> = ({
    ...
    return (
        ...
        >
            {/* Header */}
            <header className="flex-shrink-0 border-b border-police-green/10 bg-white/90 backdrop-blur-sm px-4 sm:px-6 py-3 sm:py-4 shadow-sm">
                <div className="flex items-center gap-2.5">
                    <div className="h-2.5 w-2.5 rounded-full bg-police-green animate-pulse" aria-hidden="true" />
                    <h2 className="text-base sm:text-lg font-bold text-police-green uppercase tracking-wide">
