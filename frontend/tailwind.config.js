...
export default {
  ...
  theme: {
    extend: {
      colors: {
        police: {
          green: '#00573D', // Deep Green (Vietnam Police)
          gold: '#FFCC00',  // Gold (Star/Badge)
          red: '#DA251D',   // Red (Flag)
          blue: '#004B87',  // Administrative Blue
          light: '#F0F9F4', // Light background
        }
      },
      fontFamily: {
      ...
      boxShadow: {
        'glass': '0 8px 32px rgba(0, 87, 61, 0.08)',
        'glass-lg': '0 16px 48px rgba(0, 87, 61, 0.12)',
